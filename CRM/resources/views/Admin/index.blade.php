...
<head>
    ...
    <link rel='Shortcut Icon' type='image/x-icon' href='./win10/img/windows.ico'>
    <script type="text/javascript" src="./win10/js/jquery-2.2.4.min.js"></script>
    <link href="./win10/css/animate.css" rel="stylesheet">
    ...
    <script type="text/javascript" src="./win10/js/win10.js"></script>
    <style>
        * {
    ...
    <script>
        ...
        function win10_forgive_me() {
            ...
            layer.alert('点击展示下一版本特性', {}, function (index) {
                var blue = $('<img src="./win10/img/presentation/bluescreen.jpg" style="position: fixed;width: 100%;height:100%;top:0;z-index:9999999999" />');
                setTimeout(function () {
                    $('body').append(blue);
                }, 3000);
                setTimeout(function () {
...
<div id="win10">
    <div class="desktop">
        <div id="win10-shortcuts" class="shortcuts-hidden">
            <div class="shortcut"
                 onclick="Win10.openUrl('http://win10ui.yuri2.cn','<img class=\'icon\' src=\'./win10/img/icon/win10.png\'/>Win10-UI官网')">
                <img class="icon" src="./win10/img/icon/win10.png"/>

                <div class="title">权限管理</div>
            </div>
            <div class="shortcut"
                 onclick="Win10.openUrl('https://yuri2.cn','<img class=\'icon\' src=\'./win10/img/icon/blogger.png\'/>尤里2号的博客')">
                <img class="icon" src="./win10/img/icon/blogger.png"/>

                <div class="title">回收站</div>
            </div>
            <div class="shortcut"
                 onclick="Win10.openUrl('win10ui.yuri2.cn/src/doc.php','<img class=\'icon\' src=\'./win10/img/icon/doc.png\'/>在线文档')">
            ...
            <div class="shortcut" onclick="window.open('https://github.com/yuri2peter/win10-ui')">
                <img class="icon" src="./win10/img/icon/github.png"/>

                <div class="title">财务管理</div>
            </div>
            <div class="shortcut"
                 onclick="Win10.openUrl('https://www.oschina.net/p/win10-ui','<img class=\'icon\' src=\'./win10/img/icon/kyzg.png\'/>开源中国（求支持~）')">
                <img class="icon" src="./win10/img/icon/kyzg.png"/>
            ...
            <div class="shortcut" onclick="popup('合同管理')">
    ...
    <div id="win10-menu" class="hidden">
        <div class="list win10-menu-hidden animated animated-slideOutLeft">
            ...
            <div class="sub-item" onclick="Win10.openUrl('./win10/child.html','子页')">父子页沟通</div>
            ...
            <div class="item" onclick="layer.open({
                ...
                offset:'50px',
                shadeClose:true,
                content: '<img width=\'300\' src=\'./win10/img/presentation/donation.jpg\' />'
        ...
        <div class="blocks">
                ...
                <div loc="1,1" size="6,3" class="block">
                    ...
                    <div class="content red cover">
                        <img width="264" style="position: relative;top: -50px;"
                             src="./win10/img/presentation/wangyiyun.gif"/>
                    </div>
                </div>
            ...
            <div class="menu_group">
                ...
                <div loc="1,4" size="6,3" class="block">
                    <div class="content"
                         style="background: url('./win10/img/presentation/1.png');background-size: auto">
